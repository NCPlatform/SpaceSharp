        ...
        <div className="text-center">
          <div>
            <div>
              <Row md={1}>
                <Col
                  className={`d-flex justify-content-start ${styles.BoardReadSeq}`}
                >
              ...
              <Row>
                <Col
                  className={`d-flex justify-content-start ${styles.BoardReadTitle}`}
                >
                  <div className="">
                ...
                <div className={`${styles.BoardDetailUser2}`}>
                  <div className={`${styles.BoardDetailUser3}`}>
                    <div className={`${styles.BoardDetailUser4}`}>
                      <p className={styles.BoardReadP}>
                        {userList &&
                          userList.filter(
                            (user) => user.email === boardDTO.email
                          )[0]?.name}
                        ({boardDTO.email})
                      </p>
                    </div>
            ...
            <div
              className={`${styles.BoardReadContent} d-flex justify-content-start`}
            >
              <div dangerouslySetInnerHTML={{ __html: boardDTO.content }}></div>
            </div>

            {boardDTO.email === userEmail ? (
              <div>
                <Link
                  to={`/boardUpdate/${paramSeqBoard}`}
                  className="btn btn-secondary"
                >
                  수정
                </Link>{" "}
                  ...
                  <div>
                    <div>
                      <div className={styles.BoardDetailCommentsEmail}>
                        ...
                        &nbsp;{" "}
                        {new Date(comments.releaseDate).toLocaleDateString(
                          "ko-KR"
                        )}
                      </div>{" "}
                      <br />
