                ...
                <div>
                    ...
                    <Row md={3} className="d-flex justify-content-between">
                        ...
                        <div className='d-flex justify-content-start'>
                            ...
                            <div className=''>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-android2" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.BoardReadContent} d-flex justify-content-start`}>
                        <div>
                            {removeHtmlTags(boardDTO.content)}
                        </div>
                    </div>

                    <div>
                        <Link to={`/boardUpdate/${paramSeqBoard}`} className="btn btn-secondary">수정</Link> &nbsp;
