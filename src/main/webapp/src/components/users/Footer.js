      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            <div>
              <br />
              <a href="https://blog.naver.com/spacecloud" target="_blank">
                블로그
              </a>
          ...
          <div className="col-md-6 text-end">
            <img src={img01} alt="뚱이" style={{ width: '350px', height: '100px' }} />
            <br />
            <i className="bi bi-instagram" /> &nbsp; <i className="bi bi-facebook" /> &nbsp;{' '}
            <i className="bi bi-twitter" /> &nbsp; <i className="bi bi-stickies"></i>
          </div>
        </div>
      </div>
    </footer>
