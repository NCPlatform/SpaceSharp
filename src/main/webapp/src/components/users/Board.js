  ...
  return (
    <div>
      ...
      <div className="container" style={{ minHeight: "63.8vh" }}>
        {boardCategory && (
          <p className="fs-3 fw-bold text-center">{boardCategory.title}</p>
        )}
        {seqBoardCategory && seqBoardCategory > 1 && seqBoardCategory < 7 && (
          <>
            ...
            <div className="row text-center">
              <div
                className={
                  seqBoardCategory * 1 === 2
                    ? "border-bottom col fw-bold"
                    : "col text-secondary"
                }
              ...
              <table className="table mt-3">
                <thead>
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="text-center d-none d-lg-table-cell d-xl-table-cell d-xxl-table-cell"
                      style={{ width: "20%" }}
                    >
                      등록일
                    </th>
                ...
                <tbody>
                  {boardList.map((item, index) => (
                    <TableBoardItems
                      item={item}
                      userName={
                        userList.filter((user) => user.email === item.email)[0]
                          .nickname
                      }
                      key={index}
                    />
