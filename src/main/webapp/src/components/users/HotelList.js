                  ...
                  >
                    ...
                    {selectedOption1 === "gyung-gi" && (
                      <>
                        ...
                        <option value="gyung-gi11">
                          안양, 과천, 군포, 의왕
                        </option>
                        <option value="gyung-gi12">
                          화성, 오산, 평택, 안성
                        </option>
                    ...
                    {selectedOption1 === "daegeon" && (
                      <>
                        ...
                        <option value="daegeon4">
                          중구 서대전네거리, 은행
                        </option>
                        <option value="daegeon5">
                          동구 소제, 용전, 동구청
                        </option>
                    ...
                    {selectedOption1 === "jeon-book" && (
                      <>
                        ...
                        <option value="jeon-book3">
                          익산 영등, 모현, 신동
                        </option>
                        <option value="jeon-book4">
                          군산 영동, 나운, 수송
                        </option>
                            ...
                            >
                              <div className="carousel-inner">
                                <div className="carousel-item active">
                                  <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLnJ320k-frEUlbocmV31DntmD5RmkF-UURA&usqp=CAU"
                                ...
                                <div className="carousel-item">
                                  <img
                                    src="https://mn.kbs.co.kr/data/news/2017/03/10/3442678_Fc6.png"
                                    className="d-block w-100"
                                    style={{
                                      height: "250px",
                                      objectFit: "cover",
                                ...
                                <div className="carousel-item">
                                  <img
                                    src="https://webimage.10x10.co.kr/image/basic600/274/B002748587.jpg"
                                    className="d-block w-100"
                                    style={{
                                      height: "250px",
                                      objectFit: "cover",
